...
_SteelixDexEntry::
	...
	bage "#mon body reflect"
	next "bright light well"
	dex
...
_HoundourDexEntry::
	text "Around dawn,"
	next "its ominous howl"
	next "echoes through the"

	bage "area to announce"
...
_UmbreonDexEntry::
	text "When agitated"
	next "this #mon protects"
	next "itself by spraying"

	bage "poisonous sweat"
	next "from its pores"
	dex

_SneaselDexEntry::
	text "This cunning #mon"
	next "hides under the"
	next "cover of darkness,"

	bage "waiting to attack"
	next "its prey"
	dex
...
_MisdreavusDexEntry::
	...
	bage "by screaming"
	next "loudly or"
	next "appearing suddenly"
	dex

_MarowrathDexEntry::
	text "The vengeful"
	next "spirit of Cubone's"
	next "mother, killed by"

	bage "Team Rocket."
	next "You have pacified"
	next "its wrath"
	dex

_LarvitarDexEntry::
	text "Born deep under-"
	next "ground, this #mon"
	next "becomes a pupa"
...
_TyranitarDexEntry::
	...
	next "mighty hands,"
	next "it has the power"

	bage "to make the ground"
	next "shake and"
...
_HoohDexEntry::
	...
	bage "trainer by shining"
	next "its bright rainbow"
	next "colored wings"
	dex
